...
def prMilitaryGreen(skk): return "\033[42m{}\033[00m".format(skk)


def prWhite(skk): return "\033[97m{}\033[00m".format(skk)


def prYellow(skk): return "\033[93m{}\033[00m".format(skk)


def prNiceYellow(skk): return "\033[43m{}\033[00m".format(skk)
